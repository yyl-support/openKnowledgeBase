...
## evolution
- 2026-08-04 `a2c271f` Merge pull request #312: 私密邮箱关联 GitHub login: 修复人员关联与事务提交。
- 2026-08-04 `1dce8f0` 支持私密邮箱关联 github login: 修复人员合并。
- 2026-08-03 `7cd9849` Merge pull request #311: 合并变更。
- 2026-08-03 `603f1bd` 修复采集 repo 问题: 修复仓库采集。
- 2026-08-03 `fe05659` fix(maintainers): 组织成员 Option B: primary 场景取唯一活跃关系。
