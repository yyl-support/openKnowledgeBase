...
- 数据快照日期: 待生成流程确定
- 数据来源: 待生成流程登记, 计划以仓库内已审核文档和明确标注的公开来源为准. 服务注册项由外部 backlog 输入 `.ai-flow/services/<id>.yaml` 定义, 来源为 <https://github.com/opensourceways/backlog/tree/main/.ai-flow/services>. 本公开仓库不复制 backlog 配置
